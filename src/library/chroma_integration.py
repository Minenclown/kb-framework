...
try:
    ...
    def _get_default_chroma_path() -> str:
        """Fallback when KBConfig is not available."""
...
class ChromaIntegration:
    ...
    Usage:
        ...
        from src.library.chroma_integration import get_chroma
        chroma = get_chroma()

        # Or class-level
        from src.library.chroma_integration import ChromaIntegration
    ...
    def __init__(
        ...
        if chroma_path is None:
            self.chroma_path = Path(_get_default_chroma_path())
        else:
